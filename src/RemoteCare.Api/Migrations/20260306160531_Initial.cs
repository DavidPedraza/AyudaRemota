        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupportDeviceId = table.Column<int>(type: "INTEGER", nullable: false),
                    Status = table.Column<string>(type: "TEXT", nullable: false),
                    StartedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    EndedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    FramesSent = table.Column<int>(type: "INTEGER", nullable: false),
                    FramesReceived = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sessions_Devices_SeniorDeviceId",
                        column: x => x.SeniorDeviceId,
                        principalTable: "Devices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sessions_Devices_SupportDeviceId",
                        column: x => x.SupportDeviceId,
                        principalTable: "Devices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sessions_SeniorDeviceId_SupportDeviceId_Status",
                table: "Sessions",
                columns: new[] { "SeniorDeviceId", "SupportDeviceId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sessions_SupportDeviceId",
                table: "Sessions",
                column: "SupportDeviceId");
